...
def AddExtraLayers(net, lr_mult=1):
  ...
  for i in xrange(7, 11):
    ...
    conv_name = 'conv{}_2'.format(i)
    bn_name = '{}/bn'.format(conv_name)
    scale_name = '{}/scale'.format(conv_name)
    relu_name = 'relu{}_2'.format(i)
    MobileBody(net, from_layer, num_output=num_output * 2, pad=1, stride=2, kernel_size=3,
               conv_name=conv_name, bn_name=bn_name, scale_name=scale_name, relu_name=relu_name)
    if i != 8:
...
# The name of the model. Modify it if yobatchu want.
...
mbox_source_layers = [ 'relu5_5/sep', 'relu6/sep', 'relu7_2', 'relu8_2', 'relu9_2', 'relu10_2']

# in percent %

min_sizes = [[60], [105], [150], [195], [240], [285]]
max_sizes = [[], [150], [195], [240], [285], [300]]
...
mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=mbox_source_layers,
        use_batchnorm=use_batchnorm, min_sizes=min_sizes, max_sizes=max_sizes, Mobile=True,
