...
save_dir = "models/ResNet/ResNet-18-No4/VOC0712/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/ResNet-18-No4/VOC0712/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/ResNet-18-No4/VOC0712/{}".format(job_name)
...
min_dim = 300
mbox_source_layers = ['res3b_relu', 'res4b_relu', 'res5b_relu', 'res6a_relu','res7a_relu', 'res8a_relu']
# in percent %
min_ratio = 20
max_ratio = 95
...
feature_layers = CreateMultiBoxHeadXue(net,
                                      from_layers=mbox_source_layers,
                                      use_batchnorm=False,
                                      inter_layer_depth=inter_layer_depth)
# Don't use batch norm for location/confidence prediction layers.
mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=feature_layers,
