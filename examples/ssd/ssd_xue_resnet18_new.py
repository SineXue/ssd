...
save_dir = "models/ResNet/ResNet-18-new2/VOC0712/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/ResNet-18-new2/VOC0712/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/ResNet-18-new2/VOC0712/{}".format(job_name)
